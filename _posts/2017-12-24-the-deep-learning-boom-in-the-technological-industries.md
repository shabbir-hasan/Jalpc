...
<p align="center"><img src="{{ site.img_path }}/machinelearning/AI-Artificial-Intelligence.png" alt="Deep-Learning-Artificial-Intelligence-Machine-Learning" height="auto" width="50%" max-height="100%" max-width="100%"><!-- .element height=auto width=auto max-height=100% max-width=100% --></p>
